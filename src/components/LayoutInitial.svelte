...
<main class="app-container">
  ...
  <aside class="app-content">
    <nav class="app-sidebar">
      ...
      <div class="mt-1 pb-20 text-center">
        <img src="https://www.pngall.com/wp-content/uploads/5/Profile-PNG-Images.png" alt="" class="w-10 h-10 m-auto rounded-full object-cover lg:w-28 lg:h-28">
        <h5 class="hidden mt-4 text-xl font-semibold text-white lg:block">{user.userName}</h5>
      ...
      <!-- <Tooltip> -->
        <div class="flex flex-col">
          ...
          >
            ...
            <span class="text-white text-[14px]">Dashboard</span>
          </a>
          <a
            href="/estudiar"
            ...
            background-color: #16a34a;
            justify-content: space-around;
            background-color: {hoverEstudiar ? '#1a4b2c' : '#16a34a'};
            transition: background-color 0.3s;
            "
          >
            <svg
            ...
            <span class="text-white text-[14px]">Estudiar</span>
          </a>
          <a
            href="/asistente"
            ...
            justify-content: space-around;
            transition: background-color 0.3s;
            background-color: {hoverAsistente ? '#1a4b2c' : '#16a34a'};
            "
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <span class="text-white text-[14px]">Asistente</span>
          </a>
          ...
          <a
            ...
            justify-content: space-around;
            transition: background-color 0.3s;
            background-color: {hoverGenerador ? '#1a4b2c' : '#16a34a'};
            "
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <span class="text-white text-[14px]">Generador</span>
          </a>
          <a
            href="/configuracion"
            ...
            justify-content: space-around;
            transition: background-color 0.3s;
            background-color: {hoverAjuste ? '#1a4b2c' : '#16a34a'};
            "
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <span class="text-white text-[14px]">Ajustes</span>
          </a>
          <button class="mt-4" id="logoutButton" on:click={handleLogout}
          ...
          style="
            ...
            justify-content: space-around;
            transition: background-color 0.3s;
            background-color: {hoverSalir ? '#1a4b2c' : '#16a34a'};
            ">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
            ...
            <span class="text-white text-[14px]">Salir</span>
          </button>
        </div>
    </nav>
