...
<div
class="max-w-screen-xl m-0 sm:m-20  shadow sm:rounded-lg flex justify-center flex-1 bg-background"
>
  ...
  <div class="mt-5 flex flex-col items-center">
    ...
    <div class="w-full flex-1 mt-8">
      <div class="flex flex-col items-center">
        <button
          class="w-full max-w-xs font-bold shadow-sm rounded-lg py-3 bg-secondary border-2 border-primary text-gray-800 flex items-center justify-center transition-all duration-300 ease-in-out focus:outline-none hover:shadow focus:shadow-sm focus:shadow-outline"
        >
        ...
        <button
          class="w-full max-w-xs font-bold shadow-sm rounded-lg py-3 bg-secondary border-2 border-primary text-gray-800 flex items-center justify-center transition-all duration-300 ease-in-out focus:outline-none hover:shadow focus:shadow-sm focus:shadow-outline mt-5"
        >
