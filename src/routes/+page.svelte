...
<html lang="en">
  ...
  >
    <header>
      <nav
        class="fixed overflow-hidden z-20 w-full bg-white/80 dark:bg-gray-950/0 dark:shadow-md rounded-b-lg dark:shadow-gray-950/10 border-b border-[--ui-light-border-color] border-x dark:border-[--ui-dark-border-color] backdrop-blur-2xl"
      >
          ...
          <div class="flex flex-wrap items-center justify-between py-2 sm:py-4">
            <div class="w-full items-center flex justify-between lg:w-auto">
              <a href="/" aria-label="tailus logo">
                <svg
                  class="text-gray-950 dark:text-white h-7"
                  viewBox="0 0 298 84"
                  fill="none"
    ...
    <main class="overflow-hidden">
        ...
        <div class="relative pt-24 lg:pt-28">
          <div class="mx-auto px-6 max-w-7xl md:px-12">
            ...
            >
              ...
              >
                <span
                  class="block text-sm px-2 py-0.5 rounded-[calc(var(--annonce-border-radius)-0.375rem)] text-white bg-primary-600"
                  >New</span
                >
                <span
              ...
              >
                Tame the Wild West <br class="hidden sm:block" /> of Frontend Development
              </h1>
              <p
              ...
              <p
                class="text-wrap mx-auto mt-6 max-w-2xl text-gray-700 dark:text-gray-300 sm:hidden"
              >
                      ...
                      <div>
                        <div class="h-12 w-fit mx-auto">
                          <svg
                            ...
                            style="enable-background:new 0 0 251.8 48;"
                            xml:space="preserve"
                          >
                            <g>
                              <path
              ...
              <div class="relative z-10 grid gap-3 grid-cols-6">
                ...
                >
                  <div class="size-fit m-auto relative">
                    <div class="relative h-24 w-56 flex items-center">
                      ...
                      <span
                        class="w-fit block mx-auto text-5xl font-semibold text-transparent bg-clip-text bg-gradient-to-br from-primary-300 to-accent-600 dark:from-primary-400 dark:to-accent-400"
                        >100%</span
                      >
                    </div>
                    <h2
                      class="mt-6 text-center font-semibold text-gray-950 dark:text-white text-3xl"
                    >
                      Customizable
                    </h2>
                  </div>
                    ...
                    <div class="pt-6 lg:px-6">
                      ...
                      >
                        ...
                        <defs>
                          ...
                          >
                            <stop
                              class="text-primary-300 dark:text-primary-600/30"
                              stop-color="currentColor"
                            />
                            <stop
                              class="text-white dark:text-transparent"
                              offset="1"
                              stop-color="currentColor"
                ...
                >
                  <div class="grid sm:grid-cols-2">
                    <div
                      class="flex flex-col justify-between relative z-10 space-y-12 lg:space-y-6"
                    >
                      <div
                    ...
                    >
                      ...
                      >
                        ...
                        <defs>
                          ...
                          >
                            <stop
                              class="text-primary-500/20 dark:text-primary-500/50"
                              stop-color="currentColor"
                            />
                            <stop
                ...
                >
                  <div class="h-full grid sm:grid-cols-2">
                    ...
                    >
                      <div
                        class="relative space-y-6 py-6 flex flex-col justify-center h-full"
                      >
                        <div
                          class="flex items-center justify-end gap-2 w-[calc(50%+0.875rem)] relative"
                        >
                          <span
                            class="h-fit text-xs block px-2 py-1 shadow-sm border rounded-md dark:bg-gray-800 dark:border-white/5 dark:text-white"
                            >Glodie</span
                          >
                          <div
                            class="size-7 ring-4 ring-white dark:ring-[--card-dark-bg]"
                          >
                            <img
                        ...
                        <div
                          class="flex items-center gap-2 ml-[calc(50%-1rem)] relative"
                        >
                          <div
                            class="size-8 ring-4 ring-white dark:ring-[--card-dark-bg]"
                          >
                            <img
                              class="rounded-full border border-gray-950/5 dark:border-white/5 size-full"
      ...
      <section>
        <div class="pt-36">
          <div class="mx-auto px-6 max-w-6xl text-gray-500">
            ...
            <div
              class="mt-12 relative w-fit h-fit sm:mx-auto sm:px-0 -mx-6 px-6 overflow-x-auto"
            >
              <div
                class="mb-3 flex w-fit mx-auto gap-3 text-gray-950 dark:text-white"
              >
                <div
      ...
      <section>
        <div class="pt-36">
          <div class="mx-auto px-6 max-w-6xl text-gray-500">
            <div
              class="grid gap-12 md:gap-0 md:grid-cols-2 lg:grid-cols-5 items-center lg:gap-24"
            >
              <div class="lg:col-span-2">
                <div class="md:pr-6 lg:pr-0">
                  <h2
                    class="text-3xl text-gray-950 dark:text-white font-semibold"
                  >
              ...
              >
                <div
                  class="flex gap-2 py-6 *:size-2.5 *:rounded-full px-[--card-padding]"
                >
                ...
                >
                  ...
                  <div
                    class="bg-gray-950 text-white dark:bg-white dark:text-gray-950"
                  >
                    <svg
                      class="size-7"
                      xmlns="http://www.w3.org/2000/svg"
              ...
              <div class="space-y-3">
                ...
                >
                  <div class="flex gap-3">
                    <span
                      class="relative block rounded-[--avatar-border-radius] text-lg size-10"
                    >
                      <img
                        class="h-full w-full rounded-[--avatar-border-radius] object-cover"
                        alt="John Doe"
                    ...
                    <div class="w-[calc(100%-3.25rem)]">
                      ...
                      <span
                        class="block text-sm tracking-wide text-gray-600 dark:text-gray-400"
                        >Software Ingeneer</span
                      >
      ...
      <section>
        <div class="pb-36">
          <div class="mx-auto px-6 max-w-6xl text-gray-500">
            ...
            <div
              class="mt-12 max-w-lg mx-auto flex justify-center flex-wrap gap-3"
            >
              <a
    ...
    <footer
      class="rounded-xl border border-[--ui-light-border-color] dark:border-[--ui-dark-border-color]"
    >
      <div
        class="max-w-6xl mx-auto space-y-16 px-6 py-16 text-gray-600 2xl:px-0"
      >
        <div
          class="flex flex-wrap items-center justify-between gap-4 border-b pb-8 border-[--ui-light-border-color] dark:border-[--ui-dark-border-color]"
        >
          <a href="/" aria-label="tailus logo">
            <svg
              class="text-gray-950 dark:text-white h-7"
          ...
          <div>
            ...
            <ul class="mt-4 list-inside space-y-4">
              <li>
                <a
                  href="#"
                  class="text-sm text-gray-600 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-500"
                  >About</a
                >
              </li>
              <li>
          ...
          <div>
            ...
            <form class="mt-12 max-w-xs w-full">
              ...
              >
                ...
                />
                <span
                  class="hidden peer-disabled:text-gray-600 dark:peer-disabled:text-gray-400 text-gray-500 dark:text-gray-400 text-sm"
                  >Helper message</span
                >
              </div>
              <button
                type="submit"
                class="mt-3 w-full h-9 lg:w-fit group flex items-center relative border rounded-[--btn-border-radius] *:select-none [&>*:not(.sr-only)]:relative before:rounded-[calc(var(--btn-border-radius)-1px)] before:absolute before:inset-0 before:border before:bg-gradient-to-b *:disabled:opacity-20 disabled:text-gray-950/40 disabled:border-gray-200 disabled:bg-gray-100 disabled:*:text-gray-300 disabled:before:border-transparent disabled:before:bg-gray-100 disabled:before:from-transparent dark:border-0 dark:before:border-0 dark:before:border-t dark:before:shadow-inner dark:disabled:border dark:disabled:border-gray-800/50 disabled:dark:bg-gray-900 disabled:dark:*:text-gray-700 dark:disabled:before:bg-gray-900 dark:disabled:before:from-gray-900 dark:disabled:before:shadow-none dark:*:disabled:!text-white text-white border-gray-950 bg-gray-600 before:border-gray-600 before:from-gray-800 hover:bg-gray-900 active:bg-gray-950 dark:text-gray-950 dark:before:border-gray-200 dark:before:from-gray-200 dark:bg-white dark:before:shadow-white/10 dark:hover:bg-gray-100 dark:active:bg-gray-300 dark:active:before:from-gray-200 lg:text-sm lg:h-8 px-3 justify-center"
              >
                <span>Subscribe</span>
              </button>
            </form>
        ...
        <div
          class="flex items-center justify-between rounded-md bg-gray-100 px-6 py-3 dark:bg-gray-900"
        >
          <span class="text-gray-600 dark:text-gray-400"
            >&copy; tailus 2021 - Present</span
          >
          <a
            href="#"
            class="text-sm text-gray-600 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-500"
