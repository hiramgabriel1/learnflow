            ...
            <div class="flex flex-wrap justify-center">
              ...
              >
                <div class="py-6 px-3 mt-32 sm:mt-0">
                  <button
                    class="bg-green-600 active:bg-green-700 uppercase text-white font-bold hover:shadow-md shadow text-xs px-4 py-2 rounded outline-none focus:outline-none sm:mr-2 mb-1 ease-linear transition-all duration-150"
                    type="button"
                  >
                    Editar
                  </button>
              ...
              <div class="flex flex-wrap justify-center">
                <div class="w-full lg:w-9/12 px-4">
                  <p class="mb-4 text-lg leading-relaxed text-blueGray-700">
                    ...
                    amet debitis pariatur dolorem architecto magnam officiis est
                    iusto harum, similique, veritatis vitae labore accusamus hic
                    odio. Laudantium exercitationem vel repudiandae.
                  </p>
                  <!-- <a  class="font-normal text-green-600"
                    >Mostrar mas</a
                  > -->
                </div>
              </div>
